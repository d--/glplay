...
const char * strFragPositionVertexShader = (
    "#version 330\n"
...
const char * strFragPositionFragmentShader = (
    "#version 330\n"
...
void initProgram() {
    GLuint shaders[2];
    shaders[0] = CreateShader(GL_VERTEX_SHADER, strFragPositionVertexShader);
    shaders[1] = CreateShader(GL_FRAGMENT_SHADER, strFragPositionFragmentShader);
